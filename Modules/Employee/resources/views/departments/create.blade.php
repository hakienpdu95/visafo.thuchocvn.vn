...
<div class="flex items-center justify-between mb-6">
    <div>
        ...
        <p class="text-sm text-base-content/50 mt-0.5">Định nghĩa một phòng ban/bộ phận mới trong sơ đồ tổ chức</p>
    </div>
    ...
    <div class="card bg-base-100 shadow-sm border border-base-200 max-w-xl">
        <div class="card-body space-y-4">
            ...
            <div class="form-control">
                ...
                <input type="text" name="name" value="{{ old('name') }}" placeholder="VD: Khối Sản xuất"
            ...
            <div class="form-control">
                <label class="label cursor-pointer justify-start gap-2 py-0">
                    <input type="checkbox" name="is_food_contact" value="1" class="checkbox checkbox-sm" @checked(old('is_food_contact'))>
        ...
        <div class="card-body pt-0 flex-row justify-end gap-2 border-t border-base-200">
            ...
            <button type="submit" class="btn btn-primary btn-sm">Lưu phòng ban</button>
        </div>
    </div>
</form>
@endsection
