...
@section('content')
<div x-data="departmentListPage({{ Js::from([
    'apiUrl'             => route('backend.api.departments'),
    'foodContactOptions' => $foodContactOptions,
    'canDelete'          => auth()->user()->can('delete', new \Modules\Employee\Models\Department),
]) }})">
            ...
            <div class="flex flex-wrap gap-3 items-end">
                ...
                <div class="form-control flex-1 min-w-52">
                    <label class="label py-0.5">
                        ...
                        <span class="label-text-alt text-xs text-base-content/40">Tên phòng ban</span>
                    </label>
                ...
                <div class="form-control w-56">
                    <label class="label py-0.5">
                        <span class="label-text text-xs font-medium">Tiếp xúc thực phẩm</span>
                    </label>
                    <select x-model="filters.foodContact" @change="onFilterChange()" class="select select-sm select-bordered w-full">
                        <option value="">Tất cả</option>
                        @foreach($foodContactOptions as $option)
