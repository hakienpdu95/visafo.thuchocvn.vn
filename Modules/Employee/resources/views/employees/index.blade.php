...
<div x-data="employeeListPage({{ Js::from([
    ...
    <div class="flex flex-wrap items-center justify-between gap-3 mb-5">
        <div>
            <h1 class="text-2xl font-bold text-base-content">Danh sách nhân viên</h1>
            <p class="text-sm text-base-content/50 mt-0.5">Quản lý hồ sơ nhân viên và theo dõi hạn hồ sơ y tế/ATTP</p>
        </div>
        <div class="flex items-center gap-2">
            <a href="{{ route('backend.departments.index') }}" class="btn btn-ghost btn-sm">Phòng ban</a>
            ...
            <div class="flex flex-wrap gap-3 items-end">
                ...
                <div class="form-control flex-1 min-w-52">
                    <label class="label py-0.5">
                        ...
                        <span class="label-text-alt text-xs text-base-content/40">Tên, email, SĐT, vai trò</span>
                    </label>
                ...
                <div class="form-control w-56">
                    ...
                    <select x-model="filters.department_id" @change="onFilterChange()" class="select select-sm select-bordered w-full">
