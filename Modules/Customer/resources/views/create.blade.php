...
<div class="flex items-center justify-between mb-6">
    <div>
        <h1 class="text-2xl font-bold text-base-content">Thêm khách hàng mới</h1>
        <p class="text-sm text-base-content/50 mt-0.5">Điền thông tin pháp nhân, phân loại và người đại diện của khách hàng</p>
    </div>
    <a href="{{ route('backend.customers.index') }}" class="btn btn-ghost btn-sm gap-1.5">
...
<form method="POST" action="{{ route('backend.customers.store') }}" novalidate data-customer-form>
    @csrf
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div class="form-control">
                                ...
                                <input type="text" value="KH-000001" disabled
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div class="form-control">
                                ...
                                <select id="ts-customer_group" name="customer_group"
                                    ...
                                    <option value="{{ $group->value }}" @selected(old('customer_group') === $group->value)>{{ $group->label() }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-control">
                                ...
                                <select id="ts-meal_model" name="meal_model"
                                    ...
                                    <option value="{{ $model->value }}" @selected(old('meal_model') === $model->value)>{{ $model->label() }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-control">
                            ...
                            <select id="ts-pic_id" name="pic_id"
                                ...
                                <option value="{{ $employee->id }}" @selected(old('pic_id') === $employee->id)>{{ $employee->full_name }}</option>
                                @endforeach
                            </select>
            ...
            <fieldset class="card bg-base-100 shadow-sm border border-base-200">
                <div class="card-body">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="representative_title"
                                   value="{{ old('representative_title') }}"
                                   data-val-maxlength="100"
                    ...
                    <p class="text-xs text-base-content/40 mt-4">
                        Đầu mối liên hệ về công việc (kế toán, bếp trưởng, quản lý cơ sở...) và địa điểm giao hàng
                        được quản lý sau khi tạo khách hàng, trên trang chi tiết.
                    </p>
            ...
            <div class="card bg-base-100 shadow-sm border border-base-200">
                <div class="card-body p-4">
                    ...
                    <div class="flex gap-2">
                        <a href="{{ route('backend.customers.index') }}" class="btn btn-ghost btn-sm flex-1">Hủy</a>
