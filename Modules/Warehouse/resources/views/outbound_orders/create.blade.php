...
<form method="POST" action="{{ route('backend.outbound-orders.store') }}" novalidate data-outbound-order-form>
    @csrf
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="ordered_at" id="fp-ordered-at"
                                   value="{{ old('ordered_at', now()->format('Y-m-d')) }}"
                    ...
                    <div class="form-control">
                        ...
                        <textarea name="notes" rows="3"
                                  ...
                                  placeholder="Ghi chú về đơn hàng...">{{ old('notes') }}</textarea>
    ...
    <div class="flex gap-2 pt-4 mt-2 border-t border-base-200">
        <button type="submit" class="btn btn-primary btn-sm gap-1.5">Tạo đơn</button>
