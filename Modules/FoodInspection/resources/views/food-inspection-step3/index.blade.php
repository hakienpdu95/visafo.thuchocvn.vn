...
@section('content')
<div x-data="step3ListPage({{ Js::from([
    'apiUrl'    => route('backend.api.food-inspection-step3'),
    'customers' => $customers,
    ...
    <div class="flex flex-wrap items-center justify-between gap-3 mb-5">
        <div>
            <p class="text-sm text-base-content/50 mt-0.5">Kiểm tra trước khi ăn — Mẫu số 3 (QĐ 1246/QĐ-BYT)</p>
        </div>
        <div class="flex items-center gap-2">
            ...
            @can('create', \Modules\FoodInspection\Models\FoodInspectionStep3Log::class)
            <a href="{{ route('backend.food-inspection-step3.create') }}" class="btn btn-primary btn-sm gap-1.5">
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                </svg>
                Kiểm thực Bước 3 mới
            </a>
            @endcan
