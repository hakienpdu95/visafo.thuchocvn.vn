...
@section('title', 'Lưu & hủy mẫu thức ăn')

@section('content')
<div x-data="foodSampleListPage({{ Js::from([
    'apiUrl'    => route('backend.api.food-samples'),
    'customers' => $customers,
    'statuses'  => [['value' => 'stored', 'text' => 'Lưu mẫu'], ['value' => 'pending', 'text' => 'Chờ hủy mẫu'], ['value' => 'destroyed', 'text' => 'Đã hủy']],
]) }})">

    <div class="flex flex-wrap items-center justify-between gap-3 mb-5">
        <div>
            <p class="text-sm text-base-content/50 mt-0.5">Lưu và hủy mẫu thức ăn — Mẫu số 4 & 5 (QĐ 1246/QĐ-BYT)</p>
        </div>
        <div class="flex items-center gap-2">
            ...
            @can('create', \Modules\FoodInspection\Models\FoodSampleLog::class)
            <a href="{{ route('backend.food-samples.create') }}" class="btn btn-primary btn-sm gap-1.5">
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-3 items-end">
                    ...
                    <div class="form-control lg:col-span-2">
                        <label class="label mb-2">
                            ...
                            <span class="label-text-alt text-xs text-base-content/40">Khách hàng, địa điểm, tên món</span>
                        </label>
                    ...
                    <div class="form-control">
                        ...
                        <select id="ts-status" x-model="filters.status" @change="onFilterChange()"
                                ...
                                class="select select-sm select-bordered w-full">
                            <option value="">Tất cả</option>
                            <option value="stored">Lưu mẫu</option>
                            <option value="pending">Chờ hủy mẫu</option>
