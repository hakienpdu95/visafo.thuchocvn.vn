...
const LS_COLS = 'step2-list-hidden-cols';
const EMPTY_FILTERS = { search: '', customer: '', dateFrom: '', dateTo: '', result: '' };

document.addEventListener('alpine:init', () => {

    Alpine.data('step2ListPage', (serverData = {}) => {
        const {
            apiUrl     = '',
            customers = [],
            results   = [],
        ...
        return {
            ...
            _setup() {
                ...
                tableInst = new window.Tabulator('#step2-table', {
                    ajaxURL:    apiUrl,
                    ...
                    placeholder: '<div class="py-16 text-center opacity-40">'
                        ...
                        + '<p class="text-sm">Chưa có sổ kiểm thực Bước 2 nào</p></div>',
                });

                window.step2Table = tableInst;
