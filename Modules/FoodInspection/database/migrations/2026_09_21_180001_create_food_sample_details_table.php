...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('food_sample_details', function (Blueprint $table) {
            ...
            $table->foreignUlid('step3_detail_id')->nullable()->constrained('food_inspection_step3_details')->nullOnDelete()
                ->comment('Dòng Sổ Bước 3 mà mẫu này kế thừa');
            $table->foreignUlid('menu_dish_id')->nullable()->constrained('menu_dishes')->nullOnDelete()
                ->comment('Món trong Thực đơn (khi bữa ăn chưa có Sổ Bước 3)');
            ...
            // Nhịp 2 — hủy mẫu (chỉ sau ít nhất 24 giờ kể từ sampled_at)
