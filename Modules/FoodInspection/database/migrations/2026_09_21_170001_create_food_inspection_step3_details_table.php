...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('food_inspection_step3_details', function (Blueprint $table) {
            ...
            $table->foreignUlid('step2_detail_id')->nullable()->constrained('food_inspection_step2_details')->nullOnDelete()
                ->comment('Dòng Sổ Bước 2 (món đã nấu, đạt) mà dòng này kế thừa');
            $table->foreignUlid('menu_dish_id')->nullable()->constrained('menu_dishes')->nullOnDelete()
                ->comment('Món trong Thực đơn (kể cả món ăn sẵn/tráng miệng không qua Bước 2)');
