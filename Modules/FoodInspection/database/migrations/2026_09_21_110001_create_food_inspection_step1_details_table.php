...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('food_inspection_step1_details', function (Blueprint $table) {
            ...
            // Mỗi dòng hàng gắn với NCC/người giao riêng (một buổi sáng nhập từ nhiều NCC) — cột (5)(6)(7) Mẫu số 1.
            ...
            // Chỉ áp dụng Nhóm A (tươi sống); Nhóm B để NULL.
            ...
            // Thông tin riêng Nhóm B (khô/bao gói)
