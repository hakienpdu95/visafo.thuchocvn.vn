...
/** Dựng header của Sổ Bước 3: snapshot tên cơ sở và khớp địa điểm với điểm giao/bếp ăn của khách hàng. */
class Step3LogHeader
{
    public static function from(StoreFoodInspectionStep3Data $data): array
    {
