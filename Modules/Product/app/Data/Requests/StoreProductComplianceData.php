...
class StoreProductComplianceData extends Data
{
    public function __construct(
        ...
        public readonly ?ClassificationGrade $classification_grade,
        ...
        #[Nullable, Url, Max(500)]
        public readonly ?string $pif_file_url,
    ) {}
    ...
    public static function messages(): array
    {
        return [
            ...
            'classification_grade.enum' => 'Phân loại không hợp lệ.',
            ...
            'pif_file_url.url' => 'Đường dẫn file PIF không hợp lệ.',
            'pif_file_url.max' => 'Đường dẫn file PIF không được vượt quá 500 ký tự.',
        ];
    }
}
