...
@section('title', 'Chỉnh sửa hàng hóa NCC')

@section('content')

<div class="flex items-center justify-between mb-6">
    <div>
        <h1 class="text-2xl font-bold text-base-content">Chỉnh sửa hàng hóa NCC</h1>
        <p class="text-sm text-base-content/50 mt-0.5">{{ $partnerProduct->name }}</p>
    </div>
    <a href="{{ route('backend.partner-products.show', $partnerProduct) }}" class="btn btn-ghost btn-sm gap-1.5">
...
<form method="POST" action="{{ route('backend.partner-products.update', $partnerProduct) }}" novalidate data-partner-product-form>
    @csrf
    @method('PUT')
                ...
                <div class="card-body">
                    ...
                    <div class="form-control">
                        ...
                        <select id="ts-vendor_id" name="vendor_id"
                            ...
                            <option value="{{ $vendor->id }}" @selected(old('vendor_id', $partnerProduct->vendor_id) === $vendor->id)>{{ $vendor->name }}</option>
                            @endforeach
                        </select>
                ...
                <div class="card-body">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="name" value="{{ old('name', $partnerProduct->name) }}"
                        ...
                        <div class="form-control">
                            ...
                            <select id="ts-product_id" name="product_id"
                                ...
                                <option value="{{ $product->id }}" @selected(old('product_id', $partnerProduct->product_id) === $product->id)>{{ $product->name }} ({{ $product->sku }})</option>
                                @endforeach
                            </select>
                ...
                <div class="card-body">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="manufacturer_name" value="{{ old('manufacturer_name', $partnerProduct->manufacturer_name) }}"
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="origin_address" value="{{ old('origin_address', $partnerProduct->origin_address) }}"
                ...
                <div class="card-body p-4">
                    ...
                    <div class="form-control mb-4">
                        ...
                        <select id="ts-status" name="status"
                            ...
                            <option value="{{ $status->value }}" @selected(old('status', $partnerProduct->status->value) === $status->value)>{{ $status->label() }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="flex gap-2">
                        <a href="{{ route('backend.partner-products.show', $partnerProduct) }}" class="btn btn-ghost btn-sm flex-1">Hủy</a>
