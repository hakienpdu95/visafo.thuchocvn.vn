...
@section('title', 'Hàng hóa NCC')

@section('content')
<div x-data="partnerProductListPage({{ Js::from([
    'apiUrl'    => route('backend.api.partner-products'),
    'statuses'  => $statuses,
    'canDelete' => auth()->user()->can('delete', new \Modules\Product\Models\PartnerProduct),
]) }})">

    <div class="flex flex-wrap items-center justify-between gap-3 mb-5">
        <div>
            <h1 class="text-2xl font-bold text-base-content">Hàng hóa NCC</h1>
            <p class="text-sm text-base-content/50 mt-0.5">Danh mục hàng hóa do nhà cung cấp tự kê khai, ánh xạ về danh mục chuẩn Visafo</p>
        </div>
        <div class="flex items-center gap-2">

            @can('create', \Modules\Product\Models\PartnerProduct::class)
            <a href="{{ route('backend.partner-products.create') }}" class="btn btn-primary btn-sm gap-1.5">
            ...
            <div class="flex flex-wrap gap-3 items-end">
                ...
                <div class="form-control flex-1 min-w-52">
                    <label class="label py-0.5">
                        ...
                        <span class="label-text-alt text-xs text-base-content/40">Tên hàng, mã NCC, NCC, sản phẩm chuẩn</span>
                    </label>
    ...
    <div class="card bg-base-100 shadow-sm border border-base-200">
        <div class="card-body p-0 overflow-hidden tabulator-daisy">
            <div id="partner-product-table"></div>
        </div>
    </div>
