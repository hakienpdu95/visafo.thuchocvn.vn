...
@section('title', 'Thêm nhóm hàng mới')

@section('content')

<div class="flex items-center justify-between mb-6">
    <div>
        <h1 class="text-2xl font-bold text-base-content">Thêm nhóm hàng mới</h1>
        <p class="text-sm text-base-content/50 mt-0.5">Chỉ System Admin mới được thêm nhóm hàng — mã nhóm sẽ dùng cứng trong logic pháp lý</p>
    </div>
...
<form method="POST" action="{{ route('backend.categories.store') }}" novalidate data-category-form class="max-w-xl">
    @csrf
        ...
        <div class="card-body space-y-4">
            ...
            <div class="form-control">
                ...
                <input type="text" name="name" value="{{ old('name') }}"
                       ...
                       placeholder="VD: Thực phẩm tươi sống" autofocus>
            ...
            <div class="form-control">
                ...
                <textarea name="description" rows="2"
                          ...
                          placeholder="Ghi chú thêm về nhóm hàng này">{{ old('description') }}</textarea>
            ...
            <div class="flex gap-2 pt-2">
                ...
                <button type="submit" class="btn btn-primary btn-sm flex-1">Tạo mới</button>
            </div>
