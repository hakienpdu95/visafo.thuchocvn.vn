...
<div x-data="categoryListPage({{ Js::from([
    'apiUrl'    => route('backend.api.categories'),
    'statuses'  => $statuses,
    'canDelete' => auth()->user()->can('delete', new \Modules\Product\Models\Category),
]) }})">
            ...
            <div class="flex flex-wrap gap-3 items-end">
                ...
                <div class="form-control flex-1 min-w-52">
                    <label class="label py-0.5">
                        ...
                        <span class="label-text-alt text-xs text-base-content/40">Mã, tên nhóm</span>
                    </label>
...
<dialog id="deleteModal" class="modal">
    <div class="modal-box max-w-sm">
        ...
        <p class="text-xs text-error/70">Sản phẩm đang gán nhóm này sẽ chặn thao tác xóa.</p>
