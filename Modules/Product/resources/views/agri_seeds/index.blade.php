...
@section('title', 'Từ điển giống cây trồng')

@section('content')
<div x-data="agriSeedListPage({{ Js::from([
    'apiUrl'    => route('backend.api.agri-seeds'),
    'cropTypes' => $cropTypes,
]) }})">

    <div class="flex flex-wrap items-center justify-between gap-3 mb-5">
        <div>
            <h1 class="text-2xl font-bold text-base-content">Từ điển giống cây trồng</h1>
            <p class="text-sm text-base-content/50 mt-0.5">Danh mục Giống cây trồng Quốc gia — chỉ được bật/tắt cờ cấm lưu hành</p>
        </div>
    </div>
            ...
            <div class="flex flex-wrap gap-3 items-end">
                ...
                <div class="form-control flex-1 min-w-52">
                    <label class="label py-0.5">
                        ...
                        <span class="label-text-alt text-xs text-base-content/40">Tên giống, cơ quan đăng ký, số quyết định</span>
                    </label>
                ...
                <div class="form-control w-64">
                    <label class="label py-0.5">
                        <span class="label-text text-xs font-medium">Loại cây trồng</span>
                    </label>
                    <select x-model="filters.crop_type" @change="onFilterChange()" class="select select-sm select-bordered w-full">
