...
<form method="POST" action="{{ route('backend.document-master-types.store') }}" novalidate>
    @csrf
    ...
    <div class="card bg-base-100 shadow-sm border border-base-200 max-w-2xl">
            ...
            <div class="grid grid-cols-3 gap-4">
                <div class="form-control">
                    <label class="label cursor-pointer justify-start gap-2 py-0">
                        <input type="checkbox" name="is_required_issue_date" value="1" class="checkbox checkbox-sm" @checked(old('is_required_issue_date', true))>
                ...
                <div class="form-control">
                    <label class="label cursor-pointer justify-start gap-2 py-0">
                        <input type="checkbox" name="is_required_expiry_date" value="1" class="checkbox checkbox-sm" @checked(old('is_required_expiry_date'))>
        ...
        <div class="card-body pt-0 flex-row justify-end gap-2 border-t border-base-200">
            ...
            <button type="submit" class="btn btn-primary btn-sm">Lưu loại giấy tờ</button>
        </div>
    </div>
</form>
@endsection
