...
@section('title', 'Từ điển thuốc BVTV')

@section('content')
<div x-data="agriPesticideListPage({{ Js::from([
    'apiUrl'     => route('backend.api.agri-pesticides'),
    'categories' => $categories,
]) }})">

    <div class="flex flex-wrap items-center justify-between gap-3 mb-5">
        <div>
            <h1 class="text-2xl font-bold text-base-content">Từ điển thuốc BVTV</h1>
            <p class="text-sm text-base-content/50 mt-0.5">Danh mục thuốc bảo vệ thực vật chuẩn Bộ NN&amp;PTNT — chỉ được sửa Ngày cách ly và Trạng thái cấm lưu hành</p>
        </div>
    </div>
            ...
            <div class="flex flex-wrap gap-3 items-end">
                ...
                <div class="form-control flex-1 min-w-52">
                    <label class="label py-0.5">
                        ...
                        <span class="label-text-alt text-xs text-base-content/40">Tên thương phẩm, hoạt chất, đối tượng phòng trừ</span>
                    </label>
                ...
                <div class="form-control w-64">
                    <label class="label py-0.5">
                        <span class="label-text text-xs font-medium">Nhóm thuốc</span>
                    </label>
    ...
    <div class="card bg-base-100 shadow-sm border border-base-200">
        <div class="card-body p-0 overflow-hidden tabulator-daisy">
            <div id="agri-pesticide-table"></div>
        </div>
    </div>
