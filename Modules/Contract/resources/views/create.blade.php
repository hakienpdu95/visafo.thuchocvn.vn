...
<form method="POST" action="{{ route('backend.contracts.store') }}" novalidate data-contract-form
      x-data="{ autoRenew: {{ old('is_auto_renew') ? 'true' : 'false' }} }">
    @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" inputmode="decimal" name="total_value" value="{{ old('total_value') }}"
                ...
                <div class="card-body">
                    ...
                    <label class="label cursor-pointer justify-start gap-3 py-0 mb-3">
                        <input type="checkbox" name="is_auto_renew" value="1" class="checkbox checkbox-sm"
                               x-model="autoRenew" @checked(old('is_auto_renew'))>
                    ...
                    <div x-show="autoRenew" x-transition x-cloak class="form-control max-w-xs">
                        ...
                        <input type="number" name="renewal_period_months" min="1" max="120"
                               value="{{ old('renewal_period_months') }}"
                               :required="autoRenew"
