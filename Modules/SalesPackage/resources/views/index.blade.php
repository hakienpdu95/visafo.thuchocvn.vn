...
@section('title', 'Gói chào hàng')

@section('content')
<div x-data="salesPackageListPage({{ Js::from([
    'apiUrl'   => route('backend.api.sales-packages'),
    'statuses' => $statuses,
]) }})">

    <div class="flex flex-wrap items-center justify-between gap-3 mb-5">
        <div>
            <h1 class="text-2xl font-bold text-base-content">Gói chào hàng</h1>
            <p class="text-sm text-base-content/50 mt-0.5">Đóng gói hồ sơ pháp lý &amp; truy xuất theo từng khách hàng để chào hàng</p>
        </div>
        <a href="{{ route('backend.sales-packages.create') }}" class="btn btn-primary btn-sm gap-1.5">
    ...
    <div class="section-page">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 items-end">
                    ...
                    <div class="form-control lg:col-span-2">
                        <label class="label mb-2">
                            ...
                            <span class="label-text-alt text-xs text-base-content/40">Tên gói, tên khách hàng</span>
                        </label>
        ...
        <div class="card">
            <div class="card-body p-0 overflow-hidden tabulator-daisy">
                <div id="sales-package-table"></div>
            </div>
        </div>
    </div>
</div>
...
<dialog id="deleteModal" class="modal">
    <div class="modal-box max-w-sm">
        ...
        <p class="py-3 text-sm text-base-content/70">
            Bạn có chắc muốn xóa gói chào hàng
