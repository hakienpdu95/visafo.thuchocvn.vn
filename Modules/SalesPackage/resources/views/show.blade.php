            ...
            <table class="table table-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @php $itemFiles = $item->attachedFiles(); @endphp
                            @if(count($itemFiles) > 0)
                            <div class="flex flex-wrap gap-1 max-w-[220px]">
                                @foreach($itemFiles as $file)
                                <a href="{{ $file['url'] }}" target="_blank" rel="noopener"
                                   class="inline-flex items-center gap-1 text-xs text-info bg-info/10 rounded px-2 py-1 truncate max-w-[140px]" title="{{ $file['name'] }}">
