...
<div class="flex items-center justify-between mb-6">
    <div>
        ...
        <p class="text-sm text-base-content/50 mt-0.5">Điền thông tin pháp nhân, người đại diện và đầu mối liên hệ của nhà cung cấp</p>
    </div>
...
<form method="POST" action="{{ route('backend.vendors.store') }}" novalidate data-vendor-form
      x-data="{
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="form-control sm:max-w-[calc(50%-0.5rem)]">
                            ...
                            <select id="ts-source_group" name="source_group"
                                ...
                                <option value="{{ $group->value }}" @selected(old('source_group') === $group->value)>{{ $group->label() }}</option>
                                @endforeach
                            </select>
            ...
            <div class="card bg-base-100 shadow-sm border border-base-200">
                <div class="card-body p-4">
                    ...
                    <div class="flex gap-2">
                        <a href="{{ route('backend.vendors.index') }}" class="btn btn-ghost btn-sm flex-1">Hủy</a>
