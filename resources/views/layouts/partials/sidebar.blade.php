<aside class="sidebar" id="sidebar">
    ...
    <nav class="nav-wrap">
        ...
        <div class="nav-group">
            ...
            <details {{ request()->routeIs('backend.document-repository.*', 'backend.document-master-types.*', 'backend.readiness-check.*') ? 'open' : '' }}>
                <summary class="nav-summary {{ request()->routeIs('backend.document-repository.*', 'backend.document-master-types.*', 'backend.readiness-check.*') ? 'active' : '' }}">
