...
<style>
    ...
    .tpl-visafo75 .product-name {
        font-size: 10.5pt; font-weight: 700; line-height: 1.2; letter-spacing: -.5px; text-transform: uppercase;
    ...
    .tpl-visafo75 .info-qr-row { flex: 1; min-height: 0; overflow: hidden; display: flex; align-items: flex-start; margin-top: .6mm;}
    .tpl-visafo75 .info-col { flex: none; width: 80%; min-width: 0; overflow: hidden; }
    .tpl-visafo75 .info-table { table-layout: fixed; width: 100%; border-collapse: collapse; font-size: 7.2pt; line-height: 1.15; }
    .tpl-visafo75 .info-table col.col-label { width: 13.5mm; }
    .tpl-visafo75 .info-table col.col-colon { width: 1.8mm; }
    .tpl-visafo75 .info-table td { padding: .2mm 0; vertical-align: top; overflow: hidden; }
    .tpl-visafo75 .info-table td.lbl { white-space: nowrap; font-weight: 500; font-size: 6.5pt; padding-right: 0.5mm;}
    ...
    .tpl-visafo75 .qr-caption { width: 13mm; font-size: 5.5pt; line-height: 1.2; text-align: center; overflow: hidden; }

    /* D. Footer duy nhất — 1 dòng dưới đáy tem */
    .tpl-visafo75 .footer { flex: none; height: 4.5mm; box-sizing: border-box; overflow: hidden; display: flex; justify-content: space-between; align-items: center; gap: 1mm; border-top: 1px solid #000; padding-top: 1mm; font-size: 6.5pt; line-height: 1; white-space: nowrap; }
    .tpl-visafo75 .footer > div { display: flex; align-items: center; gap: .5mm; min-width: 0; overflow: hidden; }
    .tpl-visafo75 .footer svg { width: 2.8mm; height: 2.8mm; flex: none; }
