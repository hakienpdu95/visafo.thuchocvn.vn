...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('sales_package_items')) {
            return;
        }
        ...
        Schema::create('sales_package_items', function (Blueprint $table) {
            ...
            $table->string('document_group', 30)->nullable()->comment('Snapshot document_master_types.document_group để phân thư mục khi export');
