...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('adverse_event_reports', function (Blueprint $table) {
            ...
            $table->string('mfg_or_exp_date_manual', 150)->nullable()->comment('II. Ngày sản xuất hoặc hạn dùng — nhập tay khi không liên kết được batch');
            ...
            $table->timestamp('received_at')->useCurrent()->useCurrent()->index()->comment('Thời điểm công ty nhận được khiếu nại — mốc tính hạn 7 ngày báo cáo sơ bộ');
